...
import logoTour from './logoTour.png'
...
export const roomCommonData = [
    { icon: assets.roomServiceIcon, title: "Traslados", description: "A well-maintained and hygienic space just for you." },
    { icon: assets.freeBreakfastIcon, title: "Alimentación todo incluido", description: "This host follows Staybnb's strict cleaning standards." },
    { icon: assets.homeIcon, title: "Hospedaje", description: "90% of guests rated the location 5 stars." },
    { icon: assets.heartIcon, title: "Seguro de vida", description: "100% of guests gave check-in a 5-star rating." },
    { icon: assets.guestsIcon, title: "Guía especializado", description: "100% of guests gave check-in a 5-star rating." },
];
